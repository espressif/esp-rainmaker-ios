...
class ESPMatterStorage: NSObject, MTRPersistentStorageDelegate {
    
    public static var shared = ESPMatterStorage()
    var device: String = ESPMatterConstants.emptyString
