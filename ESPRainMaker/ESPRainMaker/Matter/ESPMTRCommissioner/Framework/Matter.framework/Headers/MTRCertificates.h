...
//MARK: Cert Utility Methods:

+(uint16_t)getVendorIdFromCert:(NSData *) x509Certificate;
+(uint16_t)getProductIdFromCert:(NSData *) x509Certificate;
+(BOOL)getCertDeclaration:(NSData *) certDeclaration fromCertificate:(NSData *) x509Certificate;
+(BOOL)LogCertDeclaration:(NSData *) certificateDeclaration;
+(NSString * _Nullable) deconstructNOCSRElements:(NSData *) nocsrElements;
+(NSData * _Nullable) convertPEMToDER:(NSData*) pem;
+(NSData * _Nullable) convertPEMStringToDER:(NSString*) pem;
+(NSData * _Nullable ) getPrivateKeyData:(NSString *) privateKey;
+(NSString * _Nullable) extractPublicKeyFromPEMCert:(NSString *)certString;
+(void) validateRootCertificate:(NSData *) certData;
+(NSString *) removeHeaderAndFooter:(NSString *) certString;
+(NSData * _Nullable) convertPEMStringToCHIPCert:(NSString*) pem;
