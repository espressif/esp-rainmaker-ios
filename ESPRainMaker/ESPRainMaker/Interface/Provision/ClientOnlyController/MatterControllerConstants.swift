...
//
//  MatterControllerConstants.swift
//  ESPRainMaker
//

struct MatterControllerConstants {
    static let defaultType = "matter-controller"

    static let serviceType = "esp.service.matter-controller"
    static let setupServiceType = "esp.service.matter-controller-setup"
    ...
    static let paramGroupId = "esp.param.group-id"
