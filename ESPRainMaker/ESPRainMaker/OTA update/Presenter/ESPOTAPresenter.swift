...
//
//  ESPOTAPresenter.swift
//  ESPRainMaker
//

import Foundation

protocol ESPCheckOTAUpdatePresentationLogic {
    func checkOTAUpdate(otaUpdate: ESPOTAUpdate?, error: ESPAPIError?)
}

protocol ESPOTAUpdateStatusPresentationLogic {
    func getOTAUpdateStatus(otaUpdateStatus: ESPOTAUpdateStatus?, error: ESPAPIError?)
}

protocol ESPPushOTAUpdatePresentationLogic {
