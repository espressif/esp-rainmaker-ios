...
internal struct BinaryEncodingSizeVisitor: Visitor {
    ...
    mutating func visitSingularFloatField(value _: Float, fieldNumber: Int) throws {
    ...
    mutating func visitSingularDoubleField(value _: Double, fieldNumber: Int) throws {
    ...
    mutating func visitSingularFixed32Field(value _: UInt32, fieldNumber: Int) throws {
        let tagSize = FieldTag(fieldNumber: fieldNumber, wireFormat: .fixed32).encodedSize
        serializedSize += tagSize + MemoryLayout<UInt32>.size
    }

    mutating func visitSingularFixed64Field(value _: UInt64, fieldNumber: Int) throws {
        let tagSize = FieldTag(fieldNumber: fieldNumber, wireFormat: .fixed64).encodedSize
        serializedSize += tagSize + MemoryLayout<UInt64>.size
    }

    mutating func visitSingularSFixed32Field(value _: Int32, fieldNumber: Int) throws {
        let tagSize = FieldTag(fieldNumber: fieldNumber, wireFormat: .fixed32).encodedSize
        serializedSize += tagSize + MemoryLayout<Int32>.size
    }

    mutating func visitSingularSFixed64Field(value _: Int64, fieldNumber: Int) throws {
        let tagSize = FieldTag(fieldNumber: fieldNumber, wireFormat: .fixed64).encodedSize
