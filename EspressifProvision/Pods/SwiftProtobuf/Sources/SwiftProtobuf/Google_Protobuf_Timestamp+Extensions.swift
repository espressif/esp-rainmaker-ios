...
private func parseTimestamp(s: String) throws -> (Int64, Int32) {
    ...
    daysSinceEpoch += Int64(365 * year) - Int64(719_527)
...
private func formatTimestamp(seconds: Int64, nanos: Int32) -> String? {
    ...
    if nanos == 0 {
        ...
        return String(format: "%04d-%02d-%02dT%02d:%02d:%02d.%03dZ",
                      YY, MM, DD, hh, mm, ss, nanos / 1_000_000)
...
extension Google_Protobuf_Timestamp: _CustomJSONCodable {
    ...
    func encodedJSONString(options _: JSONEncodingOptions) throws -> String {
...
extension Google_Protobuf_Timestamp {
    ...
    public var timeIntervalSince1970: TimeInterval {
        return TimeInterval(seconds) +
            TimeInterval(nanos) / TimeInterval(nanosPerSecond)
    }
