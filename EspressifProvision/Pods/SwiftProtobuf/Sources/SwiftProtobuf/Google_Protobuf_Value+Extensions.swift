...
extension Google_Protobuf_Value {
    ...
    internal func serializeJSONValue(
        ...
        case let .numberValue(v)?: encoder.putDoubleValue(value: v)
        case let .stringValue(v)?: encoder.putStringValue(value: v)
        case let .boolValue(v)?: encoder.putBoolValue(value: v)
        case let .structValue(v)?: encoder.append(text: try v.jsonString(options: options))
        case let .listValue(v)?: encoder.append(text: try v.jsonString(options: options))
