...
internal struct TextFormatDecoder: Decoder {
    ...
    private mutating func decodeMapEntry<KeyType, ValueType: MapValueType>(mapType _: _ProtobufMap<KeyType, ValueType>.Type, value: inout _ProtobufMap<KeyType, ValueType>.BaseType) throws {
    ...
    private mutating func decodeMapEntry<KeyType, ValueType>(mapType _: _ProtobufEnumMap<KeyType, ValueType>.Type, value: inout _ProtobufEnumMap<KeyType, ValueType>.BaseType) throws where ValueType.RawValue == Int {
        var keyField: KeyType.BaseType?
    ...
    private mutating func decodeMapEntry<KeyType, ValueType>(mapType _: _ProtobufMessageMap<KeyType, ValueType>.Type, value: inout _ProtobufMessageMap<KeyType, ValueType>.BaseType) throws {
        var keyField: KeyType.BaseType?
        var valueField: ValueType?
        let terminator = try scanner.skipObjectStart()
        while true {
