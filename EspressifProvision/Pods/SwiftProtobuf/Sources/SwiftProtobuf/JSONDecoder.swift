...
internal struct JSONDecoder: Decoder {
    ...
    internal init(source: UnsafeBufferPointer<UInt8>, options: JSONDecodingOptions) {
        ...
        scanner = JSONScanner(source: source,
    ...
    mutating func decodeSingularGroupField<G: Message>(value _: inout G?) throws {
        throw JSONDecodingError.schemaMismatch
    }

    mutating func decodeRepeatedGroupField<G: Message>(value _: inout [G]) throws {
        throw JSONDecodingError.schemaMismatch
    }
