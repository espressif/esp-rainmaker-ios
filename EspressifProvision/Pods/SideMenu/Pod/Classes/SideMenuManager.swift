...
public class SideMenuManager: NSObject {
    private final class SideMenuPanGestureRecognizer: UIPanGestureRecognizer {}
    private final class SideMenuScreenEdgeGestureRecognizer: UIScreenEdgePanGestureRecognizer {}
