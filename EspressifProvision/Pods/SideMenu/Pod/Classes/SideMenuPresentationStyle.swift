...
open class SideMenuPresentationStyle: InitializableClass {
    ...
    open func presentationTransitionWillBegin(to _: UIViewController, from _: UIViewController) {}
    ...
    open func presentationTransition(to _: UIViewController, from _: UIViewController) {}
    ...
    open func presentationTransitionDidEnd(to _: UIViewController, from _: UIViewController, _: Bool) {}
    ...
    open func dismissalTransitionWillBegin(to _: UIViewController, from _: UIViewController) {}
    ...
    open func dismissalTransition(to _: UIViewController, from _: UIViewController) {}
    ...
    open func dismissalTransitionDidEnd(to _: UIViewController, from _: UIViewController, _: Bool) {}
}
