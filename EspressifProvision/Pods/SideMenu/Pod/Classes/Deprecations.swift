...
extension SideMenuManager {
    ...
    @discardableResult public func menuAddScreenEdgePanGesturesToPresent(toView _: UIView, forMenu _: [PresentDirection] = [.left, .right]) -> [UIScreenEdgePanGestureRecognizer] {
        return []
    }

    @available(*, deprecated, renamed: "addPanGestureToPresent")
    @discardableResult public func menuAddPanGestureToPresent(toView _: UIView) -> UIPanGestureRecognizer {
